...
//                     <i> directly from XTALIN pin bypassing the oscillator
...
//
//     <h> Watchdog Oscillator Setting (WDTOSCCTRL)
...
//            <15=> 4.6 MHz
//     </h>
#define WDTOSCCTRL_Val        0x00000182              // Reset value: 0x000
//
 ...
 *----------------------------------------------------------------------------*/
  ...
  /* sys_pllclkin calculation */
    ...
    #elif (__FREQSEL ==  1)
      #define __OSC_CLK              ( 600000 / __DIVSEL)
    #elif (__FREQSEL ==  2)
      #define __OSC_CLK              (1050000 / __DIVSEL)
    #elif (__FREQSEL ==  3)
      #define __OSC_CLK              (1400000 / __DIVSEL)
    #elif (__FREQSEL ==  4)
      #define __OSC_CLK              (1750000 / __DIVSEL)
    #elif (__FREQSEL ==  5)
      #define __OSC_CLK              (2100000 / __DIVSEL)
    #elif (__FREQSEL ==  6)
      #define __OSC_CLK              (2400000 / __DIVSEL)
    #elif (__FREQSEL ==  7)
      #define __OSC_CLK              (2700000 / __DIVSEL)
    #elif (__FREQSEL ==  8)
      #define __OSC_CLK              (3000000 / __DIVSEL)
    #elif (__FREQSEL ==  9)
      #define __OSC_CLK              (3250000 / __DIVSEL)
    #elif (__FREQSEL == 10)
      #define __OSC_CLK              (3500000 / __DIVSEL)
    #elif (__FREQSEL == 11)
      #define __OSC_CLK              (3750000 / __DIVSEL)
    #elif (__FREQSEL == 12)
      #define __OSC_CLK              (4000000 / __DIVSEL)
    #elif (__FREQSEL == 13)
      #define __OSC_CLK              (4200000 / __DIVSEL)
    #elif (__FREQSEL == 14)
      #define __OSC_CLK              (4400000 / __DIVSEL)
    #else
      #define __OSC_CLK              (4600000 / __DIVSEL)
    #endif
...
static void setPLL(const uint32_t pllMode, const uint32_t pllInFreq, const uint32_t reqCpuFreq)
{
  ...
  ROM ** rom = (ROM **) 0x1FFF2004;             /* pointer to power API calls */
